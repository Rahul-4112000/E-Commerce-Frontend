...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = 'px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed';
